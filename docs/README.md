...
> 归档位置：`C:\Users\xiaofeng\Documents\Dev\docs\AgentChat`
...
| [`../src/docs/`](../src/docs/) | **src 轨道设计档案**：里程碑方案（M7-M27）、域深设计、计划/调研/审计——索引见 [`../src/README.md`](../src/README.md)「设计档案索引」 |
...
| [../src/docs/](../src/docs/) | 设计档案：里程碑方案 M7-M27、会话域深设计、LLM 池重构方案、WebUI 插槽化调研等 |
...
3. **轨道内设计文档直接落 `src/docs/` 并在 `src/README.md` 设计档案索引登记**；本目录不放轨道内文档（2026-11 归整：`ui-descriptive-text-inventory.md`、`event-graphs.html` 已迁 `src/docs/`）。
