...
import { createContext, pushSteer, drainSteer } from '../src/core/context';
import type { CurrentContext } from '../src/core/context';
import type { LLMProvider, Message } from '../src/core/types';
...
describe('createContext', () => {
  ...
  it('保留传入字段（含显式 steer）', () => {
    const steer: Message[] = [{ role: 'user', content: 'hi' }];
