...
// ac-client-ui-jobs/client（owning = 前端行）——本模块 re-export
// 维持旧 import 路径；纯视图拆分（splitJobs/jobOutputPreview 等）留
// 视图层。实时性：job/started · job/settled 事件帧驱动域服务重拉
//（ac-client-ui-jobs client 半边 ctx.jobBoard）。
// ============================================================

export type { WireJob } from 'ac-client-ui-jobs/client';
export { fetchJobs, killJob } from 'ac-client-ui-jobs/client';

import type { WireJob } from 'ac-client-ui-jobs/client';
