...
import { fetchAgents as fetchAgentsRpc } from 'ac-client-ui-agents/client';
...
export function useSettings() {
  ...
  //（M27.2-2 随件迁：wireRpc.onWireEvent → rpc 契约面 onEvent——同语义直转）
  const disposePluginWs = wireRpc.onEvent((type: string, args: unknown[]) => {
