...
export const meta = {
  ...
  configuration: [
    ...
    { name: 'keepRecentRatio', label: '归档保留比例', description: '归档后保留的最近消息比例（相对于 maxContextTokens）。Agent 会自动整理记忆，原始对话可激进截断', type: 'ratio', default: 0.03, min: 0.01, max: 0.3, step: 0.005 },
