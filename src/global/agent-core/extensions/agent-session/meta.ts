...
export const meta = {
  ...
  configuration: [
    ...
    { name: 'idleArchiveSec', label: '空闲归档时间', description: '无对话自动归档的等待时间（秒）', type: 'number', default: 3600 },
...
function defaults(): SessionConfig {
  return { maxContextTokens: 1000000, keepRecentRatio: 0.10, summaryPreviewLen: 1000, idleArchiveSec: 3600, archiveMinMessages: 200, messageQueryDefaultLimit: 50 };
}
