// ============================================================
// contracts/dialog.ts —— 会话键纯函数（契约层，零依赖）
//
...
//
// 归位说明（2026-08-20 修订）：会话键构造/解析是全栈共享的底层语义，
//   下沉到契约层以消除低层包（toolkit/tools 等）对 @agentchat/agents 的
//   向上依赖；agents/src/paths.ts 保留 re-export 兼容既有导入
//   （router/L2 仍可从本包引），新代码一律从 @agentchat/contracts 引入。
//
