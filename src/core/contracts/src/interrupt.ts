 ...
 * 'modules' = L1.5 主动模块热重载（reload_modules 工具宣告，见 docs/restart-design.md §2）。
 */
export type ReloadScope = 'self' | 'global' | 'all' | 'modules';
...
export type InterruptReason =
  ...
  | { type: 'reload-requested'; scope: ReloadScope; files?: string[] } // Agent 请求热重载（scope='modules' 携带 file:// URL 清单）
