// ============================================================
// ac-web-search-core/src/types.ts —— web_search 共享类型 & SearchProvider 接口
// （src web/web-search/types 原样平移；零 cordis 依赖）
// ============================================================

/** 传递给 provider 的运行时配置（apiKey 来自 ac-credentials 解析链或环境变量） */
