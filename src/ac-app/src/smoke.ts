...
// 数据根：无条件锚定 <repo>/workspace/test（与 pnpm test 同一集中管理的
// 临时目录，启动前自清理；路径护栏同 vitest global-setup）。不读外部
// AGENTCHAT_DATA_ROOT——机器级 env 会把冒烟劫持到真实数据根：三连接
// fixture 缺失 → gpt-4o-mini NO_PROVIDER，且 probe/会话文件污染真实根。
// ============================================================
