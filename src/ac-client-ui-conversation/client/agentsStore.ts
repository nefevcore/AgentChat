// ============================================================
// ac-client-ui-conversation/client/agentsStore.ts —— Agent 门面
//（M27 S2 兼容桥接 ctx.roster；M27.2-2 随 conversation 件迁入——
// feed/chat 核心的名册消费面；webui stores/agents re-export 维持
// 旧路径，sidebar 面板壳等消费面零改动）
//
...
// conversation 收尾时本门面退役，消费面全量切 ctx.roster。
// ============================================================
...
import type { AgentPresetInfo } from 'ac-client-ui-agents/client';
