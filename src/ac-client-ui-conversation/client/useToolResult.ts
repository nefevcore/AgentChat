// ============================================================
// client/useToolResult.ts —— 工具结果解析与渲染 composable（M27.2-2 视图半边自 webui composables/ 迁入）
// 组件分发改由 core/registry/toolResultViews 注册表承担（扩展点）。
// ============================================================

import { computed, type Ref } from 'vue';
import { resolveToolResultView } from 'ac-client-ui-tool/client/toolResultViews.ts';
