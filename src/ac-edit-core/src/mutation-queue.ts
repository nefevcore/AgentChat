// ============================================================
// ac-edit-core/src/mutation-queue.ts —— 文件写入并发安全（src 原样继承）
//
// LLM 并发发起多个 edit/write 调用时，同一文件的写操作串行化，
// 不同文件仍然并行（src 教训：同文件并行编辑交错风险——
// str_replace_editor 无此队列即翻车，地图 §3.4 缺口）。
//
// 设计要点：
