// ============================================================
// ac-client-ui-usage/client/rpcDefault.ts —— 缺省 rpc 锚
//（settings/layout 包同款：clientRuntime 单例委托；未装配 → 拒绝桩）
// ============================================================
import { clientRuntime, type RpcClientFace } from 'ac-client-runtime';

function noRuntime(): Promise<never> {
  return Promise.reject(new Error('client runtime 未装配（usage 包内缺省 rpc）'));
}
