// ============================================================
// preview/scripts/unify-group-storage.ts —— D11 存储统一一次性整备
//
// 用法：npx tsx scripts/unify-group-storage.ts [数据根=../workspace/preview]
// （相对 preview/；或绝对路径）
//
...
const ROOT = path.resolve(PREVIEW_DIR, process.argv[2] ?? '../workspace/preview');
