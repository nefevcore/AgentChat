// ============================================================
// preview/supervisor.mjs —— AgentChat preview 宿主监护进程
//
...
const ROOT_DIR = path.dirname(PREVIEW_DIR);
const WORKER_ENTRY = path.join(PREVIEW_DIR, 'ac-app', 'src', 'boot.ts');
const RUNTIME_LOCK = runtimeLockPath(PREVIEW_DIR);
